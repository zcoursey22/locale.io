...
app.get('/api/stories', (req, res) => {
  const stories = [
    ...
    { title: 'Watch Out For Pidgeons', author: 'Jane Doe', comments: 3, likes: 1, categories: ['other'], liked: false, disliked: true, time: new Date('August 24, 2018 17:14:44'), latitude: 37.755957, longitude: -122.416702,
