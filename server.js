...
app.get('/api/stories', (req, res) => {
  const stories = [
    { title: 'New Dog Park Opening Soon', author: 'Zach Coursey', comments: 1, likes: 4,
    ...
    { title: 'Construction In The Downtown Area', author: 'John Doe', comments: 0, likes: 3,
    ...
    { title: 'Watch Out For Pidgeons', author: 'Jane Doe', comments: 3, likes: 1,
